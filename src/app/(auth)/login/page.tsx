      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-xl border border-gray-100">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            {isLogin ? "Access your secure stokvel portal" : "Establish your new savings circle"}
          </p>
        </div>
        ...
        <form action={isLogin ? login : signUp} className="space-y-4">
          {!isLogin && (
            <>
              ...
              <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                ...
                />
                <p className="text-[9px] text-emerald-600 mt-1 italic">This will be the name of your ledger.</p>
              </div>

              {/* 2. PERSONAL DETAILS (Now Second) */}
              ...
              <div>
                ...
                <input name="phone" type="tel" placeholder="082 123 4567" required className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-emerald-500 outline-none" />
              </div>
            </>
          )}
          ...
          <button type="submit" className="w-full rounded-lg bg-emerald-600 px-4 py-3 text-white font-bold hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100 mt-4 active:scale-[0.98]">
